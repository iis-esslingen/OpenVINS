 ...
 * This can be used to initialize the system or for plotting and calculation of RMSE values without needing any
 * alignment.
 *
 * > M. Burri, J. Nikolic, P. Gohl, T. Schneider, J. Rehder, S. Omari,M. Achtelik and R. Siegwart,
 * > "The EuRoC micro aerial vehicle datasets", International Journal of Robotic Research,
 * DOI: 10.1177/0278364915620033, 2016. > https://projects.asl.ethz.ch/datasets/doku.php?id=kmavvisualinertialdatasets.
 */
class DatasetReader
{
public:
